...
export default function TaskForm({ onTaskSaved, task }) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!form.assignedUser) return alert("Please select a user");
  ...
  return (
    <form onSubmit={handleSubmit} className="p-6 border rounded-lg shadow-md max-w-md mx-auto space-y-4 bg-white">
